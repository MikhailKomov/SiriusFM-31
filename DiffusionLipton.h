...
private:
    ...
    public:
         ...
         DiffusionLipton(double mu,double sigma1,double sigma2, double sigma3): m_mu(mu),m_sigma1(sigma1),m_sigma2(sigma2),m_sigma3(sigma3)
                {if (sigma1<=0 || sigma3 <= 0 || sigma2*sigma2 - 4*sigma1*sigma3 >= 0)
                    {
